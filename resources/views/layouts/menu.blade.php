<li class="nav-item">
	<a href="{{ route('dd20.index') }}" class="nav-link {{ Request::is('dd20*') ? 'active' : '' }}">
		...
		<p><label>Digital Directive</label></p>
	</a>
</li>
...
<li class="nav-item">
	<a href="#" class="nav-link">
		...
		<i class="text-muted nav-icon fas fa-tasks"></i>
		<p><label class="text-muted">Contracker</label></p>
...
<li class="nav-item">
	<a href="#" class="nav-link">
		...
		<i class="text-muted nav-icon fas fa-users"></i>
		<p><label class='text-muted'>Players</label></p>
	</a>
</li>
...
<li class="nav-item">
	<a href="#" class="nav-link">
		...
		<i class="text-muted nav-icon fas fa-luggage-cart"></i>
		<p><label class="text-muted">Economy</label></p>
	</a>
</li>
